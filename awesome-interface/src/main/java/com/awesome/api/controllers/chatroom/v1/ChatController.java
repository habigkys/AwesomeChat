...
public class ChatController {
    ...
    public void enter(ChatMessageDTO message) throws Exception{
        ...
        if(!Objects.isNull(chatRoom.getChatRoomMessageEntities())) {
            redisClient.publish(topic, ChatMessageDTO.convertEntityToDto(chatRoom.getChatRoomMessageEntities().get(0)));
        }
    }
